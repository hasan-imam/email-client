...
public class MailClient extends Frame {
	...
	private TextField mailServerField= new TextField("",40);
	private Label mailServerLabel=new Label("Local mailserver:");
...
create an extra panel for holding all the child panels. */
		Panel mailServerPanel=new Panel(new BorderLayout());
		Panel fromPanel = new Panel(new BorderLayout());
		Panel toPanel = new Panel(new BorderLayout());
		Panel subjectPanel = new Panel(new BorderLayout());
		Panel messagePanel = new Panel(new BorderLayout());
		mailServerPanel.add(mailServerLabel,BorderLayout.WEST);
		mailServerPanel.add(mailServerField,BorderLayout.CENTER);
		...
		fieldPanel.add(mailServerPanel);
...
buttons. */
	...
	class SendListener implements ActionListener {
		public void actionPerformed(ActionEvent event) {
			...
			/* Create the message */
			Message mailMessage = new Message(mailServerField.getText(),fromField.getText(),
					toField.getText(),
