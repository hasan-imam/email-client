...
from RFC 822 (From, To, Date). */
	public Message(String mailServer,String from, String to, String subject, String text)
	{
		/* Remove whitespace */
		From = from.trim();
		To = to.trim();
...
only GMT. */
	...
	/* Three functions to access the sender and recipient, and the mail server */
